    ...
    Action
      ...
      <div class="client-card">
        ...
        <div class="info">
          ...
          <a href="<?= site_url('client/edit/' . $element["IDclient"]) ?>" class="ajax-link"><div class="menu"></div></a>
...
<div class="footer_list"> 
    ...
    <button type="button" class="btn btn-add" data-url="<?= site_url('client/edit/0') ?>">Ajouter</button>
            </div>
