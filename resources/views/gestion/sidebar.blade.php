...
<div class="sidebar_accueil">
    ...
    <div class="nav-menu">
        <a href="#" data-action="accueil" class="nav-item {{ ($activepage ?? '') == 'index' ? 'active' : '' }}" Onclick="setActiveMenuItem('accueil')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <path d="M64 0C28.7 0 0 28.7 0 64L0 352c0 35.3 28.7 64 64 64l176 0-10.7 32L160 448c-17.7 0-32 14.3-32 32s14.3 32 32 32l256 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-69.3 0L336 416l176 0c35.3 0 64-28.7 64-64l0-288c0-35.3-28.7-64-64-64L64 0zM512 64l0 224L64 288 64 64l448 0z"/>
            </svg>
            <span>Dashboard</span>
        ...
        <a href="#" data-action="articles" class=" nav-item {{ ($activepage ?? '') == 'articles' ? 'active' : '' }}" Onclick="setActiveMenuItem('articles')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M0 24C0 10.7 10.7 0 24 0L69.5 0c22 0 41.5 12.8 50.6 32l411 0c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3l-288.5 0 5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5L488 336c13.3 0 24 10.7 24 24s-10.7 24-24 24l-288.3 0c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5L24 48C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/></svg>
            <span>Articles</span>
        </a>

        <a href="#" data-action="categories" class="nav-item {{ ($activepage ?? '') == 'categories' ? 'active' : '' }}" Onclick="setActiveMenuItem('categories')">
        ...
        <a href="#" data-action="emplacements" class="nav-item {{ ($activepage ?? '') == 'emplacements' ? 'active' : '' }}" Onclick="setActiveMenuItem('emplacements')">
        ...
        <a href="#" data-action="mouvements" class="nav-item {{ ($activepage ?? '') == 'mouvements' ? 'active' : '' }}" OnClick="setActiveMenuItem('mouvements')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <a href="#" data-action="fournisseurs" class="nav-item {{ ($activepage ?? '') == 'fournisseurs' ? 'active' : '' }}" OnClick="setActiveMenuItem('fournisseurs')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.nav-menu a').click(function (e) {
            ...
            const url = "{{ url('gestion') }}/" + action; // ✅ Correction ici
            console.log("url " + url);
        ...
        $(document).on('click', '.btn-details', function() {
            ...
            let url = "{{ url('gestion/loadData') }}/" + type; // ✅ Correction ici
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Vérifier si la fonction updateCharts existe
                    if (typeof updateCharts === 'function' && response.chartData) {
