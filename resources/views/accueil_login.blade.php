...
<body class="background-login">
	...
	<div class="login-container">
        ...
        <form method="post" name="login_connection" action="{{ route('admin.index') }}">
            @csrf
            <label for="username">Identifiant</label>
            <input type="text" id="username" name="login" placeholder="Entrez votre nom" required>
