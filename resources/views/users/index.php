...
<body>
    ...
    <div class="body-dashboard-container">
        <div class="dashboard-container">
            <h1>Utilisateur</h1>
            <form action="<?= site_url("/utilisateur/save"); ?>" method="post">
            <div>
            ...
            <div class="form-grid">
                ...
                <div>
                    ...
                    <input type="text" name="tel_pro" id="tel_pro">
                </div>
                ...
                <select name="id_societe" id="id_societe" required>
                    <option value="" disabled selected>-- Sélectionnez une société --</option>
                    <option value="1">Société Alpha</option>
                    <option value="2">Société Beta</option>
                    <option value="3">Société Gamma</option>
                    <option value="4">Société Delta</option>
                </select>
            </div>
            </div>
