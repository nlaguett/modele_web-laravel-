    ...
    <div class="sidebar_accueil">
        ...
        <div class="nav-menu">
            ...
            <a href="<?= site_url('client'); ?>" class="nav-item">
            ...
            <a href="<?= site_url('societe'); ?>" class="nav-item">
            ...
            <a href="<?= site_url("statistiques")?>" class="nav-item">
    ...
    <div class="main-content">
            <div class="list"></div>
                        <div class="list-item">
                            <span>Header</span>
                            <div>
                                <a href="<?= site_url('header'); ?>"><button class="blue-btn">Voir</button></a>
                                <a href="<?= site_url("posts/My_update/header"); ?>"><button class="yellow-btn">Modifier</button></a>
                        ...
                        <div class="list-item">
                            <span>Footer</span>
                            <div>
                                <a href="<?= site_url('footer'); ?>"><button class="blue-btn">Voir</button></a>
                                <a href="<?= site_url("posts/My_update/footer"); ?>"><button class="yellow-btn">Modifier</button></a>
                ...
                <?php foreach ($posts as $post): ?>
                        ...
                        <div class="list-item">
                            ...
                            <div>
                                <a href="<?= site_url($post['slug']); ?>"><button class="blue-btn">Voir</button></a>
                                <a href="<?= site_url("posts/My_update/".$post['id']); ?>"><button class="yellow-btn">Modifier</button></a>
                                <a href="<?= site_url($post['id']); ?>"><button class="red-btn">Supprimer</button></a>
                            </div>
                        </div>
                <?php endforeach; ?>
                <div class="list-item"><span>&nbsp;</span><div><a href="<?= site_url($post['id']); ?>"><button class="green-btn">Ajouter</button></a></div></div>
            </div>
        </div>
